...
function renderTotals() {
    ...
    firestore.collection("Users/"+email+"/cart").get().then(function(querySnapshot) {
        ...
        subtotalText.innerHTML = "Rs "+subtotal.toFixed(2);
        deliveryFeeText.innerHTML = "Rs "+deliveryFee.toFixed(2);
        total = subtotal + deliveryFee;
        tipAmnt = total*tip;
        total = total + tipAmnt;
        tipAmount.innerHTML = "Rs " + tipAmnt.toFixed(2);
        totalText.innerHTML = "Rs " + total.toFixed(2);
...
function getRadioVal() {
    ...
    if(tip != "Other%" && tip != "Other$") updateTotal();
        ...
        tipExplain.innerText = "Enter tip amount in Rupees:";
        tipExplain.style.display = "block";
    }
}
